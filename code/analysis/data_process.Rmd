...
ggplot() + 
  geom_point(aes(vertex_attr(g_out, "participation index"), vertex_attr(g_out, "local hubness"), color = "points")) +
  ggtitle("Out Degree") +
...
ggplot() + 
  geom_point(aes(vertex_attr(g_in, "participation index"), vertex_attr(g_in, "local hubness"), color = "points")) +
  ggtitle("Out Degree") +
  labs(x = 'Participation', y = 'Local Hubness', color="Legend") + scale_color_manual(values=c("#F8766D", "#00BFC4"))+
    theme(legend.position = "none")
